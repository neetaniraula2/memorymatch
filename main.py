...
#creates a 2d arroay of zeros
board = np.zeros((rows, cols, 2))

characters =[u'\u0293',u'\u0278',u'\u03C0',u'\u03A9', u'\u03A8',u'\u03A3',u'\u0414',u'\u0411']

#loops throught our characters twice
# and palces a character at the index
def make_board():
  for i in range(2):
...
def get_choice(limit, pos, turn):
  while True:
    try:
      ...
      print("Invalid number. Please enter a number brterrn 1 and {}". format(limit))
    else:
      if idx == limit:
    ...
    if first_flip:
      ...
      if board [r2, c2, 0 ] == 1.0:
        ...
        if board[r1, c1, 1 ] == board[r2, c2, 1]:
          ...
          board [r2, c2, 0] = 0.0
          print_board()
  print("You completed in {} attempts". format(attempts))
